// ==UserScript==
// @name         FML-P3 (BLS Algeria)
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  Autofill 3-person BLS Algeria appointments (Tourist Visa)
// @author       @bessou
    ...
    function TheBigBro() {
        ...
        if (table !== "") {
            ...
            if (document.getElementById("app_date").value.length === 0 && finDate !== "") {
                ...
                document.title === "504 Gateway Timeout"
            ) {
                ...
                setTimeout(() => {
                    for (let i = 0; i < number; i++) {
                        ...
                        document.getElementById('VisaTypeId-' + j).selectedIndex = 1; // Tourist
        ...
        if (document.getElementById("app_date").value.length === 0) {
            setTimeout(() => window.location.reload(), 19000);
        }
    }
})();
