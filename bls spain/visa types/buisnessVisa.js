// ==UserScript==
// @name         BLS Algeria - Business Visa Auto-Fill
// @namespace    http://tampermonkey.net/
// @version      1.2
// @description  Auto-fill BLS Algeria for Business visa appointments (user must manually fill personal data in code below)
// @author       @bessou
    ...
    function doMagic() {
        ...
        if (table !== "") {
            ...
            if (document.getElementById("app_date").value.length === 0 && finDate !== "") {
                ...
                if (document.getElementById("VisaTypeId")) document.getElementById("VisaTypeId").selectedIndex = 4; // Business Visa
